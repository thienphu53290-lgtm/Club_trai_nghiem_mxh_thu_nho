...
const Stats = () => {
  return (
    <section className="px-5 pb-10">
      <div className="max-w-[1320px] mx-auto grid grid-cols-3 bg-white relative z-10 border border-border-color rounded-[16px] sm:rounded-[24px] overflow-hidden shadow-[0_4px_12px_rgba(0,0,0,0.02)]">
